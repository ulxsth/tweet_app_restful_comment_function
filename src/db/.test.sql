...
INSERT INTO users (id, name, email, image_name, password, created_at, updated_at) VALUES(11,'for create comment','11@progate.com','/image/users/default_user.jpg','$2b$10$eWozvPlv.OwVm3TUeZifjOsu5ylPs1727cnR7AzmRsNe/DD2UOOtq','2021-04-23 11:44:18.073','2021-04-23 11:44:18.073');
-- UPDATE COMMENT TESTS
INSERT INTO users (id, name, email, image_name, password, created_at, updated_at) VALUES(12,'for update comment','12@progate.com','/image/users/default_user.jpg','$2b$10$eWozvPlv.OwVm3TUeZifjOsu5ylPs1727cnR7AzmRsNe/DD2UOOtq','2021-04-23 11:44:18.073','2021-04-23 11:44:18.073');
-- DELETE COMMENT TESTS
INSERT INTO users (id, name, email, image_name, password, created_at, updated_at) VALUES(13,'for delete comment','13@progate.com','/image/users/default_user.jpg','$2b$10$eWozvPlv.OwVm3TUeZifjOsu5ylPs1727cnR7AzmRsNe/DD2UOOtq','2021-04-23 11:44:18.073','2021-04-23 11:44:18.073');
-- EDIT COMMENT TESTS
INSERT INTO users (id, name, email, image_name, password, created_at, updated_at) VALUES(14,'for edit comment','14@progate.com','/image/users/default_user.jpg','$2b$10$eWozvPlv.OwVm3TUeZifjOsu5ylPs1727cnR7AzmRsNe/DD2UOOtq','2021-04-23 11:44:18.073','2021-04-23 11:44:18.073');
-- INDEX COMMENT TESTS
INSERT INTO users (id, name, email, image_name, password, created_at, updated_at) VALUES(15,'for index comment','15@progate.com','/image/users/default_user.jpg','$2b$10$eWozvPlv.OwVm3TUeZifjOsu5ylPs1727cnR7AzmRsNe/DD2UOOtq','2021-04-23 11:44:18.073','2021-04-23 11:44:18.073');
-- posts
...
-- CREATE COMMENT TEST
INSERT INTO posts (id, content, user_id, created_at, updated_at) VALUES(16,'create comment',1,'2022-0-731 05:24:15.529','2022-03-31 05:24:15.529');
-- UPDATE COMMENT TEST
INSERT INTO posts (id, content, user_id, created_at, updated_at) VALUES(17,'update comment',1,'2022-03-31 05:24:15.529','2022-03-31 05:24:15.529');
-- DELETE COMMENT TEST
INSERT INTO posts (id, content, user_id, created_at, updated_at) VALUES(18,'delete comment',1,'2022-03-31 05:24:15.529','2022-03-31 05:24:15.529');
-- EDIT COMMENT TEST
INSERT INTO posts (id, content, user_id, created_at, updated_at) VALUES(19,'edit comment',1,'2022-03-31 05:24:15.529','2022-03-31 05:24:15.529');
-- INDEX COMMENT TEST
INSERT INTO posts (id, content, user_id, created_at, updated_at) VALUES(20,'index comment',1,'2022-03-31 05:24:15.529','2022-03-31 05:24:15.529');
INSERT INTO posts (id, content, user_id, created_at, updated_at) VALUES(21,'index comment',1,'2022-03-31 05:24:15.529','2022-03-31 05:24:15.529');
INSERT INTO posts (id, content, user_id, created_at, updated_at) VALUES(22,'index comment',1,'2022-03-31 05:24:15.529','2022-03-31 05:24:15.529');
-- likes
...
-- comments
-- UPDATE COMMENT TEST
INSERT INTO comments(id, user_id, post_id, content, created_at, updated_at) VALUES(1, 12, 17, "update target", '2022-07-01 06:21:11.447', '2022-07-01 06:23:11.447');
INSERT INTO comments(id, user_id, post_id, content, created_at, updated_at) VALUES(2, 1, 17, "not owner comment", '2022-07-01 06:21:11.447', '2022-07-01 06:23:11.447');
-- DELETE COMMENT TEST
INSERT INTO comments(id, user_id, post_id, content, created_at, updated_at) VALUES(3, 13, 18, "delete target", '2022-07-02 06:21:11.447', '2022-07-02 06:23:11.447');
INSERT INTO comments(id, user_id, post_id, content, created_at, updated_at) VALUES(4, 13, 18, "not delete target", '2022-07-01 06:21:11.447', '2022-07-01 06:23:11.447');
INSERT INTO comments(id, user_id, post_id, content, created_at, updated_at) VALUES(5, 1, 18, "not owner comment", '2022-07-01 06:21:11.447', '2022-07-01 06:23:11.447');
-- EDIT COMMENT TEST
INSERT INTO comments(id, user_id, post_id, content, created_at, updated_at) VALUES(6, 14, 19, "edit target", '2022-07-02 06:21:11.447', '2022-07-02 06:23:11.447');
INSERT INTO comments(id, user_id, post_id, content, created_at, updated_at) VALUES(7, 1, 19, "not owner comment", '2022-07-02 06:21:11.447', '2022-07-02 06:23:11.447');
-- INDEX COMMENT TEST
INSERT INTO comments(id, user_id, post_id, content, created_at, updated_at) VALUES(8, 15, 20, "index target", '2022-07-02 06:21:11.447', '2022-07-02 06:23:11.447');
INSERT INTO comments(id, user_id, post_id, content, created_at, updated_at) VALUES(9, 1, 21, "not owner comment", '2022-07-02 06:21:11.447', '2022-07-02 06:23:11.447');
INSERT INTO comments(id, user_id, post_id, content, created_at, updated_at) VALUES(10, 1, 22, "newest comment", '2022-07-03 06:21:11.447', '2022-07-02 06:23:11.447');
INSERT INTO comments(id, user_id, post_id, content, created_at, updated_at) VALUES(11, 1, 22, "oldest comment", '2022-07-02 06:21:11.447', '2022-07-02 06:23:11.447');
COMMIT;
